...
export const CardRaceRequest = (params) => {
  ...
  return (
    <div className="card-race__container bg-black-600 transition rounded-xl flex flex-row mb-8">
      <img src={params.image} className="object-cover rounded-l-xl h-auto w-28 sm:w-32" />
      <div className="pl-2 flex flex-col sm:flex-row w-full">
        ...
        <div className="self-center flex flex-row sm:flex-col justify-center items-center gap-3 mb-4 mt-1">
          ...
          <button onClick={rejectRace} className="bg-gray-600 font-rubik text-sm text-gray-50 rounded-full px-2 py-1 sm:py-2 sm:px-4 sm:mx-4 sm:mt-4">
            Rechazar
          </button>
        </div>
      </div>
