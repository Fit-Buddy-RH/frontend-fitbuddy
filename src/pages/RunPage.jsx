...
export const RunPage = () => {
  ...
  console.log("value starts", value)
              ...
              <div className="card-comment__container bg-black-600 transition rounded-xl flex flex-col my-4" >
                <div className="grid grid-cols-12">
                  <section className="col-span-2 flex flex-col justify-center items-center p-4">
                    ...
                    />
                    <div>
                      <h3 className=" hidden md:block text-gray-50 text-xl font-bold italic mb-4 text-center">
                        Usuario
                      </h3>
                  ...
                  <section className="col-span-10 bg-black-700 rounded-xl p-4 m-4">
                    <section className="flex justify-between">
                      <div className="">
                        <div>
                          <input type="text" className="w-[139px] h-[59px] text-{5px} md:text-{16px} pl-1.5 font-rubik mb-4 rounded-lg md:w-[358px] h-[54px]" placeholder="Escribe un título..." {...register("title", { required: true, maxLength: 100 })} />
                        </div>
                        {/* <AddPhoto/>
                      <form id="inputImage">
                    ...
                    <textarea placeholder="Coméntanos como te fue..." id="comments" name="w3review" rows="4" cols="110" className="w-full rounded-lg pl-1.5" label="comentanos" {...register("comment", { required: true, maxLength: 400 })} ></textarea>
                    <input type="submit" value="Compartir" className="button__orange text-xs sm:text-lg text-gray-50 bg-orange-900 font-rubik italic font-bold px-4 py-2 sm:px-8 rounded-full transition" />
                  </section>
                </div>
              </div>
